...
export const tl: TranslationKeys = {
  ...
  hero: {
    ...
    subheadline: 'Ang Sirvoy ang bahala sa mga booking. Ang Palawan Collective ang bahala sa lahat — staff, pera, pagkain, imbentaryo, at araw-araw na operasyon. Magsimula sa kailangan mo. Magdagdag pa habang lumalaki.',
